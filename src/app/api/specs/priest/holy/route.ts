...
export async function GET(req: NextRequest) {
  return NextResponse.json(
    {
      ...
      description: `
  <div style="width:100%;height:160px;border-radius:8px;overflow:hidden;background:#1b495c;background: linear-gradient(90deg, rgba(255, 215, 0, 0.6) 0%, rgba(255, 215, 0, 0.3) 40%, rgba(255, 215, 0, 0) 100%), url('/images/holypriestCover.png'); background-size: cover; background-position: right center; background-repeat: no-repeat;"></div>
  <br>
  ...
  `,
      ...
      GemsDesc: `Meta - <a rel="noreferrer noopener" href="https://wowclassicdb.com/wotlk/item/41401" target="_blank" class="wowclassicdb-link " style="font-size: 1rem;"></a> <br>
        ...
        Yellow - <a rel="noreferrer noopener" href="https://wowclassicdb.com/wotlk/item/40155" target="_blank" class="wowclassicdb-link " style="font-size: 1rem;"></a><br>
        Blue - <a rel="noreferrer noopener" href="https://wowclassicdb.com/wotlk/item/40133" target="_blank" class="wowclassicdb-link " style="font-size: 1rem;"></a> <br>
      `,
          ...
          items: [
            {
              id: 1003,
              name: "+22 Agility",
              html: ':&nbsp; <a rel="noreferrer noopener" href="https://wowclassicdb.com/wotlk/item/44498" target="_blank" class="wowclassicdb-link " style="font-size: 1rem;"></a>',
            },
          ],
        },
        {
          ...
          items: [
            {
              id: 1003,
              name: "+22 Agility",
              html: ':&nbsp; <a rel="noreferrer noopener" href="https://wowclassicdb.com/wotlk/spell/44498" target="_blank" class="wowclassicdb-link " style="font-size: 1rem;"></a>/<a rel="noreferrer noopener" href="https://wowclassicdb.com/wotlk/item/38979" target="_blank" class="wowclassicdb-link " style="font-size: 1rem;"></a>&nbsp;(Engineering)',
            },
          ],
        },
        {
          ...
          items: [
            {
              id: 1003,
              name: "+22 Agility",
              html: ':&nbsp; <a rel="noreferrer noopener" href="https://wowclassicdb.com/wotlk/item/44487" target="_blank" class="wowclassicdb-link " style="font-size: 1rem;"></a>',
            },
          ],
        },
      ],
          ...
          items: [
            {
              ...
              html: '<a rel="noreferrer noopener" href="https://wowclassicdb.com/wotlk/item/51261" target="_blank" class="wowclassicdb-link " style="font-size: 1rem;"></a>',
          ...
          items: [
            {
              id: 1,
              name: "Helm of the Fallen Champion",
              html: '<a rel="noreferrer noopener" href="https://wowclassicdb.com/wotlk/item/51264" target="_blank" class="wowclassicdb-link " style="font-size: 1rem;"></a>',
              source: "Icecrown Citadel — Lich King (25HC)",
            },
          ],
        },
          ...
          items: [
            {
              ...
              html: '<a rel="noreferrer noopener" href="https://wowclassicdb.com/wotlk/item/51260" target="_blank" class="wowclassicdb-link " style="font-size: 1rem;"></a>',
          ...
          items: [
            {
              ...
              html: '<a rel="noreferrer noopener" href="https://wowclassicdb.com/wotlk/item/51262" target="_blank" class="wowclassicdb-link " style="font-size: 1rem;"></a>',
              source: "Icecrown Citadel — Lich King (25HC)",
            },
          ],
        },
          ...
          items: [
            {
              ...
              source: "Trial of the Crusader — Anub'arak (25)",
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              html: '<a rel="noreferrer noopener" href="https://wowclassicdb.com/wotlk/item/46017" target="_blank" class="wowclassicdb-link " style="font-size: 1rem;"></a>&nbsp;or&nbsp;<a rel="noreferrer noopener" href="https://wowclassicdb.com/wotlk/item/50734" target="_blank" class="wowclassicdb-link " style="font-size: 1rem;"></a>',
              source:
                "Ulduar — Yogg-Saron (25) / Icecrown Citadel — Lich King (25HC)",
            },
          ],
        },
        {
