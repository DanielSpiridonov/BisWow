  ...
  return NextResponse.json(
    {
      ...
      description: `
  <div style="width:100%;height:160px;border-radius:8px;overflow:hidden;background:#1b495c;background: linear-gradient(90deg, rgba(178, 34, 34, 0.6) 0%, rgba(178, 34, 34, 0.4) 45%, rgba(178, 34, 34, 0.2) 70%, rgba(178, 34, 34, 0) 100%), url('/images/deathknightCover.jpg'); background-size: cover; background-position: right center; background-repeat: no-repeat;"></div>
  <br>
  <div style="padding:20px 26px;border-radius:8px;">
  <p style="font-size: 1.2rem;">Blood Death Knight is a tank that excels at self-sustain and controlling enemies in raids and dungeons. It leverages powerful cooldowns and Death Strike healing to smooth damage and anchor tough encounters.</p>
  </div>
  <br><br>
          ...
          items: [
            {
              ...
              source: "Icecrown Citadel — Trash (25HC)",
            },
          ],
        },
        {
