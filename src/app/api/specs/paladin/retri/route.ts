...
export async function GET(req: NextRequest) {
  return NextResponse.json(
    {
      buildName:
        "Talent Builds for Paladin - Retribution in Wrath of the Lich King",
      description: `
  <div style="width:100%;height:160px;border-radius:8px;overflow:hidden;background:#1b495c;background: linear-gradient(90deg, rgba(255, 215, 0, 0.6) 0%, rgba(255, 215, 0, 0.3) 40%, rgba(255, 215, 0, 0) 100%), url('/images/retripalaCover.png'); background-size: cover; background-position: right center; background-repeat: no-repeat;"></div>
  <br>
          ...
          items: [
            {
              ...
              html: '<a rel="noreferrer noopener" href="https://wowclassicdb.com/wotlk/item/51277" target="_blank" class="wowclassicdb-link " style="font-size: 1rem;"></a>',
          ...
          items: [
            {
              id: 1,
              name: "Helm of the Fallen Champion",
              html: '<a rel="noreferrer noopener" href="https://wowclassicdb.com/wotlk/item/51279" target="_blank" class="wowclassicdb-link " style="font-size: 1rem;"></a>',
              source: "Icecrown Citadel — Professor Putricide (25HC)",
            },
          ],
        },
          ...
          items: [
            {
              ...
              source: "Icecrown Citadel — Blood Princes (25HC)",
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              html: '<a rel="noreferrer noopener" href="https://wowclassicdb.com/wotlk/item/51275" target="_blank" class="wowclassicdb-link " style="font-size: 1rem;"></a>',
          ...
          items: [
            {
              ...
              html: '<a rel="noreferrer noopener" href="https://wowclassicdb.com/wotlk/item/50659" target="_blank" class="wowclassicdb-link " style="font-size: 1rem;"></a>',
          ...
          items: [
            {
              ...
              html: '<a rel="noreferrer noopener" href="https://wowclassicdb.com/wotlk/item/50690" target="_blank" class="wowclassicdb-link " style="font-size: 1rem;"></a>',
          ...
          items: [
            {
              ...
              html: '<a rel="noreferrer noopener" href="https://wowclassicdb.com/wotlk/item/51278" target="_blank" class="wowclassicdb-link " style="font-size: 1rem;"></a>',
              source: "Icecrown Citadel — Professor Putricide (25HC)",
            },
          ],
        },
          ...
          items: [
            {
              ...
              source: "Icecrown Citadel — Ashen Verdict (Reputation)",
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              html: '<a rel="noreferrer noopener" href="https://wowclassicdb.com/wotlk/item/50706" target="_blank" class="wowclassicdb-link " style="font-size: 1rem;"></a>',
              source: "Icecrown Citadel — Lady Deathwhisper (25HC)",
            },
          ],
        },
          ...
          items: [
            {
              ...
              html: '<a rel="noreferrer noopener" href="https://wowclassicdb.com/wotlk/item/50455" target="_blank" class="wowclassicdb-link " style="font-size: 1rem;"></a>',
              source: "Dalaran — Vendor",
            },
          ],
        },
      ],
