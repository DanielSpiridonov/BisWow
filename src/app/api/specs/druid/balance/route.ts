  ...
  return NextResponse.json(
    {
      ...
      description: `
  <div style="width:100%;height:160px;border-radius:8px;overflow:hidden;background:#ffffff;background: linear-gradient(90deg, rgba(255, 255, 255, 0.6) 0%, rgba(255, 255, 255, 0.25) 50%, rgba(255, 255, 255, 0) 100%), url('/images/boomkingCover.png'); background-size: cover; background-position: right center; background-repeat: no-repeat;"></div>
  <br>
  <div style="padding:20px 26px;border-radius:8px;">
  <p style="font-size: 1.2rem;">Balance Druid is a ranged caster DPS used for raids and dungeons, offering strong utility and steady AoE and single-target damage. It brings reliable raid buffs and performs well on sustained encounters with frequent multi-target opportunities.</p>
  </div>
  <br><br>
          ...
          items: [
            {
              ...
              html: '<a rel="noreferrer noopener" href="https://wowclassicdb.com/wotlk/item/51290/" target="_blank" class="wowclassicdb-link " style="font-size: 1rem;"></a>',
          ...
          items: [
            {
              id: 1,
              name: "Helm of the Fallen Champion",
              html: '<a rel="noreferrer noopener" href="https://wowclassicdb.com/wotlk/item/51292/" target="_blank" class="wowclassicdb-link " style="font-size: 1rem;"></a>',
              source: "Icecrown Citadel — Professor Putricide (25HC)",
            },
          ],
        },
          ...
          items: [
            {
              ...
              html: '<a rel="noreferrer noopener" href="https://wowclassicdb.com/wotlk/item/51294/" target="_blank" class="wowclassicdb-link " style="font-size: 1rem;"></a>',
          ...
          items: [
            {
              ...
              html: '<a rel="noreferrer noopener" href="https://wowclassicdb.com/wotlk/item/51291/" target="_blank" class="wowclassicdb-link " style="font-size: 1rem;"></a>',
