  ...
  return NextResponse.json(
    {
      ...
      description: `
  <div style="width:100%;height:160px;border-radius:8px;overflow:hidden;background:#001b44;background: linear-gradient(90deg, rgba(0, 27, 68, 0.6) 0%, rgba(0, 27, 68, 0.25) 50%, rgba(0, 27, 68, 0) 100%), url('/images/feraltankCover.png'); background-size: cover; background-position: right center; background-repeat: no-repeat;"></div>
  <br>
  <div style="padding:20px 26px;border-radius:8px;">
  <p style="font-size: 1.2rem;">Feral Druid (Tank) is a durable, mobile tank used to control packs and survive heavy hits in raids and dungeons. It offers high health, strong mitigation, and excellent mobility for kiting or repositioning enemies.</p>
  </div>
  <br><br>
