...
export async function GET(req: NextRequest) {
  ...
  <p style="font-size: 1.2rem;">Destruction Warlock is a ranged caster DPS with bursty direct damage and reliable cleave for raids and dungeons. It shines on priority-target nuking and cleave, rewarding precise cooldowns and strict Immolate uptime.</p>
  </div>
  <br><br>
          ...
          items: [
            {
              ...
              source: "Trial of the Crusader — T10 set",
          ...
          items: [
            {
              ...
              source: "Darkmoon Faire — Darkmoon Card Vendor",
