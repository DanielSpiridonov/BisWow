...
export async function GET(req: NextRequest) {
  ...
  <p style="font-size: 1.2rem;">Affliction Warlock is a DoT-focused ranged caster DPS valued for sustained damage and utility in raids and dungeons. It shines in multi-target pressure and executes, rewarding perfect DoT uptime and shard management.</p>
  </div>
  <br><br>
          ...
          items: [
            {
              id: 1003,
              name: "+22 Agility",
              html: ':&nbsp; <a rel="noreferrer noopener" href="https://wowclassicdb.com/wotlk/item/39006" target="_blank" class="wowclassicdb-link " style="font-size: 1rem;"></a>/ <a rel="noreferrer noopener" href="https://wowclassicdb.com/wotlk/spell/55016" target="_blank" class="wowclassicdb-link " style="font-size: 1rem;"></a>',
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              source: "Icecrown Citadel — T10 Set",
            },
          ],
        },
        {
