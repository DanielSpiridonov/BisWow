...
export async function GET(req: NextRequest) {
  ...
  <p style="font-size: 1.2rem;">Fury Warrior is a dual-wield melee DPS known for fast-paced sustained damage in raids and dungeons. It thrives on gearing and uptime, scaling hard with stats and rewarding aggressive cooldown usage.</p>
  </div>
  <br><br>
          ...
          items: [
            {
              ...
              source: "Onyxia's Lair — Onyxia (25)",
            },
          ],
        },
        {
