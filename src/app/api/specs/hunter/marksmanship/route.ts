  ...
  return NextResponse.json(
    {
      ...
      description: `
  <div style="width:100%;height:160px;border-radius:8px;overflow:hidden;background:#0b3d1b;background: linear-gradient(90deg, rgba(11, 61, 27, 0.6) 0%, rgba(11, 61, 27, 0.25) 50%, rgba(11, 61, 27, 0) 100%), url('/images/marksmanhunterCover.png'); background-size: cover; background-position: right center; background-repeat: no-repeat;"></div>
  <br>
  <div style="padding:20px 26px;border-radius:8px;">
  <p style="font-size: 1.2rem;">Marksmanship Hunter is a ranged physical DPS specializing in burst and armor penetration scaling, bringing strong single-target and utility to dungeons and raids. It excels at executing priority targets and benefits heavily from proper gearing and careful cooldown alignment.</p>
  </div>
  <br><br>
          ...
          items: [
            {
              ...
              source: "Trial of the Crusader — Faction Champions (10/25)",
            },
          ],
        },
        {
